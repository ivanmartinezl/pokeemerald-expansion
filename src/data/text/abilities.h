...
static const u8 sStenchDescription[] = _("Helps avoiding attacks.");
static const u8 sMagicianDescription[] = _("Powers psychic moves.");
...
static const u8 sBattleArmorDescription[] = _("Blocks crits, reduce fight.");
...
static const u8 sSuctionCupsDescription[] = _("Anchor the body, resists ground.");
...
static const u8 sIlluminateDescription[] = _("Resists dark and fairy.");
...
static const u8 sMagmaArmorDescription[] = _("Resists Ice and freeze.");
static const u8 sWaterVeilDescription[] = _("Prevents burns.");
static const u8 sMagnetPullDescription[] = _("Traps Steel-type Pokémon.");
static const u8 sSwatterDescription[] = _("Traps Bug-type Pokémon.");
...
static const u8 sPressureDescription[] = _("Pressure and Unnerve.");
static const u8 sThickFatDescription[] = _("Heat-and-cold protection.");
static const u8 sEarlyBirdDescription[] = _("Awakens quickly, boost fly in sun.");
...
static const u8 sKeenEyeDescription[] = _("Boost Acc and prevents loss.");
...
static const u8 sStickyHoldDescription[] = _("No item theft, boost Dfs. in weather.");
...
static const u8 sOvergrowDescription[] = _("Ups Grass moves.");
static const u8 sBlazeDescription[] = _("Ups Fire moves.");
static const u8 sTorrentDescription[] = _("Ups Water moves.");
static const u8 sSwarmDescription[] = _("Ups Bug moves.");
...
static const u8 sShellArmorDescription[] = _("Blocks crits, reduces bug dmg.");
...
static const u8 sNaturalReserveDescription[] = _("Adjusts defense favorably.");
...
static const u8 sLeafGuardDescription[] = _("Cures status in sunshine.");
...
static const u8 sAnticipationDescription[] = _("Feels danger, prevents priority.");
static const u8 sForewarnDescription[] = _("Determines a foe's ability.");
...
static const u8 sTelepathyDescription[] = _("No dmg. by ally, resists psy.");
...
static const u8 sDancerDescription[] = _("Dances with priority.");
...
static const u8 sScreenCleanerDescription[] = _("Sets screens with priority.");
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_NATURAL_RESERVE] = _("NatReserve"),
    [ABILITY_FIERCE_KICK] = _("Fierce Kick"),
    [ABILITY_SWATTER] = _("Swatter"),
};
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT] =
{
    ...
    [ABILITY_SWATTER] = sSwatterDescription,
    ...
    [ABILITY_NATURAL_RESERVE] = sNaturalReserveDescription,
