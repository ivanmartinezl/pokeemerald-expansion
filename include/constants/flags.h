...
#define FLAG_TEMP_5      (TEMP_FLAGS_START + 0x5)  //Unused
...
#define FLAG_UNUSED_0X020    0x20 //Unused
...
#define FLAG_HIDDEN_ITEM_TM51  0x264 // Unused Flag
